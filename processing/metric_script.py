...
def remove_units(sorting, min_spike_number):    
    return sorting

def detect_ground_truth_spikes()


def compare_sortings(raw_sorting_file, di_sorting_file, gt_sorting_file, min_spike_number=10):
    ...
    # remove units with few spikes
    gt_sorting = remove_units(gt_sorting, min_spike_number)
    raw_sorting = remove_units(raw_sorting, min_spike_number)
    di_sorting = remove_units(di_sorting, min_spike_number)
